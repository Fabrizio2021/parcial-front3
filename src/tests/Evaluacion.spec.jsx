    ...
    describe("Form", ()=>{
        ...
        describe('On error', () => {
            describe("Should show an error message",()=>{
                it("If the first input length is less than 3", async ()=>{
                    ...
                    const errorMessage = await screen.findByText("Por favor verifique los datos ingresados ​​en el formulario.")
        ...
        describe('On success', () => {
            it("Should render a Card with the proper information", async ()=>{
                ...
                const errorMessage = screen.queryByText("Por favor verifique los datos ingresados ​​en el formulario.")
